...
The functionality is similar to the :mod:`pylhc_submitter.job_submitter` in that
...
.. note::
    Unlike in the :mod:`pylhc_submitter.job_submitter`, the output directory of the
